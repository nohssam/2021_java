...
public class Ex02 {
	public static void main(String[] args) {
		...
		double d3 = d2 / 10 ;      // d2가 int 이므로 d2 / 10 은 int 이다. 
		System.out.println(d3);    // 24.0 
		
		double d4 = d2/10.0;      // d2가 int 이므로 d2 / 10.0은 double 이다.
	   ...
	   // 어떤 수를 5로 나눈 나머지는 0,1,2,3,4  다섯가지만 존재
